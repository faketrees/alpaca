...
def flatten(data)
    ...
    #data will start out as an array 
    # find out the number of elements inside of the main array

    flattened = []
    data.each do |ele| 
        flattened += flatten(ele)
        # it breaks out if data is not an array, otherwise it goes even deeper
